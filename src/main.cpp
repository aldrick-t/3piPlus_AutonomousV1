...
signed long int encCountsL = encoders.getCountsAndResetLeft();
signed long int encCountsR = encoders.getCountsAndResetRight();
bool bumpLeft = false;
...
char opMenu(char mode) {
  ...
  display.gotoXY(0,2);
  display.print("Turt. Full Auto w/ :A");
  display.gotoXY(0,3);
  display.print(" Obs. Avoid & Line   ");
  display.gotoXY(0,4);
  display.print("Doubt Events       :B");
  display.gotoXY(0,5);
  display.print(" Asks user for input ");
  display.gotoXY(0,7);
